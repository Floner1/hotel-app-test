/* =====================================================
   THIEN TAI HOTEL — DATABASE SCHEMA v7
   ---------------------------------------------------------
   Single-file build script. Drops every existing object and
   recreates the full schema with seed data.

   HOW TO RUN:
     1. Open SSMS, connect to your SQL Server instance.
     2. If the `hotelbooking` database does not exist:
            CREATE DATABASE hotelbooking;
     3. Open this file and execute it (F5). It will:
          - drop all existing tables / views / triggers
          - recreate the full schema
          - insert default hotel, prices, services, 53 rooms

   AFTER RUNNING:
     - Register an account at /accounts/register/
     - Promote it to admin from SSMS:
           UPDATE users SET role='admin' WHERE username='<yours>';
     - The email_subscribers / email_campaigns / email_queue
       tables start empty; rows are populated by the app.

   Changes vs v6:
     - Removed dropped-but-never-created trigger references
     - Section headers normalized
     - Inserted explicit USE-database guard
===================================================== */
...
/* =====================================================
   9. TRIGGERS & VIEWS — row-level security via SESSION_CONTEXT
===================================================== */
...
/* =====================================================
   10. SEED DATA — hotel info, prices, services
===================================================== */
...
/* =====================================================
   11. SEED ROOMS — 53 physical rooms
...
/* =====================================================
   DONE — schema build complete.
   Verify:
       SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES ORDER BY TABLE_NAME;
   Expect 15 tables including email_subscribers / email_campaigns / email_queue.
===================================================== */
